...
const forEachPokemon = function printEachPokemon() {
...
const filterPokemons = function pokeFilter(pokeType) {
  return pokemons
    .filter((pokemon) => pokemon.types.includes(pokeType))
...
const searchPokemons = function pokeSearch(name) {
